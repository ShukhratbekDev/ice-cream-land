...
const ShoppingCartModal = () => {
  ...
  const { isCartModalOpen, setCartModalState } = useBasicStore();

  return (
    <Sheet open={isCartModalOpen} onOpenChange={() => setCartModalState(!isCartModalOpen)}>
      <SheetContent className="sm:max-w-lg w-[90vw]">
        ...
        <div className="h-full flex flex-col justify-between">
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div className="mt-6">
              <Button className="w-full bg-black text-white">Pay now</Button>
            </div>
